  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-3 px-2">
        ...
        <p
          className="font-display text-display-2xl text-text-white leading-none"
          aria-live="polite"
          aria-atomic="true"
        >
          {score}
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-3 px-2">
        ...
        <p
          className={`font-display text-display-2xl leading-none ${streak > 0 ? 'text-brand-yellow' : 'text-text-white'}`}
          aria-live="polite"
          aria-atomic="true"
        ...
        {streak > 0 && (
          <span
            key={streak}
            className="font-display text-display-base leading-none mt-0.5 animate-multi-bump text-streak-gold"
            aria-hidden="true"
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-3 px-2">
        ...
        <p
          className="font-display text-display-xl text-text-muted leading-none"
          aria-live="polite"
          aria-atomic="true"
        >
          {highScore}
